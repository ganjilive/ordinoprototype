...
import type { TestCasesStepStatus } from '../../hooks/useTestCasesWorkflow';

interface TestCasesTimelineProps {
...
export function TestCasesTimeline({ steps, currentStep }: TestCasesTimelineProps) {
  return (
