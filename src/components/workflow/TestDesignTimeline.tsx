...
import type { TestDesignStepStatus } from '../../hooks/useTestDesignWorkflow';

interface TestDesignTimelineProps {
  steps: { id: number; status: TestDesignStepStatus }[];
  currentStep: number;
}
...
export function TestDesignTimeline({ steps, currentStep }: TestDesignTimelineProps) {
  return (
