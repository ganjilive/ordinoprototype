  ...
  return (
    ...
    >
      <div className="w-20 h-20 rounded-full bg-ordino-primary/20 flex items-center justify-center mb-6">
        <PlayCircle className="w-10 h-10 text-ordino-primary" />
      </div>
      <h2 className="text-2xl font-semibold text-ordino-text mb-3">
        Test Execution Demo
      </h2>
      <p className="text-ordino-text-muted max-w-md">
        This demo workflow is coming soon. It will showcase the AI-powered test execution
        process including test run management, result analysis, and defect tracking.
      </p>
    </motion.div>
  );
}
