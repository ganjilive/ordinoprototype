...
import type { RequirementsStepStatus } from '../../hooks/useRequirementsWorkflow';

interface RequirementsTimelineProps {
  steps: { id: number; status: RequirementsStepStatus }[];
  currentStep: number;
}
...
export function RequirementsTimeline({ steps, currentStep }: RequirementsTimelineProps) {
  return (
