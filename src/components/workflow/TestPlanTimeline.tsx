...
import type { TestPlanStepStatus } from '../../hooks/useTestPlanWorkflow';

interface TestPlanTimelineProps {
  steps: { id: number; status: TestPlanStepStatus }[];
  currentStep: number;
}
...
export function TestPlanTimeline({ steps, currentStep }: TestPlanTimelineProps) {
  return (
