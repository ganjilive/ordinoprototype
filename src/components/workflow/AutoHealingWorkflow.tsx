...
import { AutoHealingTimeline } from './AutoHealingTimeline';
import { useAutoHealingWorkflow } from '../../hooks/useAutoHealingWorkflow';
import {
  FailureDetected,
...
export function AutoHealingWorkflowComponent() {
  const {
    currentStep,
    steps,
    isPlaying,
    ...
    <div className="space-y-6">
      ...
      <Card>
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold text-ordino-text">Auto-Healing Tests</h2>
      ...
      {currentStep > 0 && (
        <div className="flex gap-6">
          {/* Timeline sidebar */}
          <AutoHealingTimeline steps={steps} currentStep={currentStep} />
