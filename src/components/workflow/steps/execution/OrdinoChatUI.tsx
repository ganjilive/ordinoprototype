...
import { chatResponses, suggestedQuestions } from '../../../../data/testExecutionMockData';
import type { ExecutionChatMessage } from '../../../../types';

export function OrdinoChatUI() {
  const [messages, setMessages] = useState<ExecutionChatMessage[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I\'m Ordino. I can answer questions about your test execution results. Try asking about pass rate, failed tests, coverage, trends, or recommendations.',
      timestamp: new Date(),
    },
  ]);
  ...
  const findResponse = (query: string): string => {
    ...
    return `I don't have specific information about "${query}". Try asking about:
- Pass rate
- Failed tests
- Coverage report
- Trends
...
- Recommendations`;
  ...
  const handleSend = (text?: string) => {
    ...
    setTimeout(() => {
      ...
      const assistantMessage: ExecutionChatMessage = {
    ...
    >
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-ordino-text-muted">
          Ask questions about your test execution results
        </p>
      </div>
