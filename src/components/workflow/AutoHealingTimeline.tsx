...
import type { AutoHealingStepStatus } from '../../hooks/useAutoHealingWorkflow';

interface AutoHealingTimelineProps {
  steps: { id: number; status: AutoHealingStepStatus }[];
  currentStep: number;
}
...
export function AutoHealingTimeline({ steps, currentStep }: AutoHealingTimelineProps) {
  return (
