...
import type { AutomationStepStatus } from '../../hooks/useAutomationWorkflow';

interface AutomationTimelineProps {
  steps: { id: number; status: AutomationStepStatus }[];
  currentStep: number;
}
...
export function AutomationTimeline({ steps, currentStep }: AutomationTimelineProps) {
  return (
